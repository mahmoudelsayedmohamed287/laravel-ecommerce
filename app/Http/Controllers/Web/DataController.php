...
class DataController extends Controller
{
    ...
    public function productsFetures(){
				...
				if(isset($_REQUEST['category'])){	
					$cat = \DB::table('categories')->where('categories_slug',$_REQUEST['category'])->get();		
					$categories->where('products_to_categories.categories_id','=', $cat[0]->categories_id);
					$categories->where('categories_description.language_id','=',Session::get('language_id'));
				}
				...
				$products  = $categories->take(3)->get();
