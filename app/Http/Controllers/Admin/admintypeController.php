...
//        ->LeftJoin('products', 'products.products_id', '=', 'orders.orders_id')
        ->where('customers_id','!=','')
    ...
    foreach($orders as $orders_data){
        ...
        $orders_products = DB::table('orders_products')
            ->join('products', 'orders_products.products_id', '=', 'products.products_id')
             ->select('products.*','orders_products.final_price',DB::raw('SUM(orders_products.final_price) as total_price') ,'orders_products.products_id','orders_products.products_quantity')
//            ->select('products.admin_id','final_price', DB::raw('SUM(final_price) as total_price') ,'products_id','products_quantity' )
            ->where('orders_id', '=' ,$orders_data->orders_id)
            ->where('products.admin_id', '=', session('admin_id'))
            // ->where('adminstrators.myid', '=', session('admin_id'))
            ->groupBy('final_price')
            ->get();
