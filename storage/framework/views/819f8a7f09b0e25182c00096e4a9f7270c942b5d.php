<?php if($result['filters']): ?>
 ...
 <div id="accordion"  class="filters" role="tablist">
     ...
     <div class=" card">
     <div class=" card-header"><a style="color:black;" href="<?php echo e(URL::to('/shop?type=special')); ?>">hotdeals</a></div></div>
    
 	<form enctype="multipart/form-data" name="filters" method="get">
        <input type="hidden" name="min_price" id="min_price" value="0">

        <?php $seller =  isset($_REQUEST['seller']) ? $_REQUEST['seller'] : null ?>
        <input type="hidden" name="seller" id="seller" value="<?php echo e($seller); ?>">
