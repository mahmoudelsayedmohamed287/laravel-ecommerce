    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <?php endif; ?>
         ...
         <li class="treeview">
          <a href="<?php echo e(URL::to('admin/singleadmin')); ?>" ><i class="fa fa-dashboard"></i> <span><?php echo e(trans('labels.header_dashboard')); ?> </span></a>
        </li>  
          <?php endif; ?>
...
<span><?php echo e(trans('labels.link_categories')); ?> </span> <i class="fa fa-angle-left pull-right"></i>
     ...
     <?php endif; ?>
           <!-- <li class="">
          <a href="<?php echo e(URL::to('admin/register/affilate')); ?>" ><i class="fa fa-tablet" aria-hidden="true"></i> <span><?php echo e(trans('labels.affilate')); ?></span></a>
        </li> -->
...
<span><?php echo e(trans('labels.link_notifications')); ?></span> <i class="fa fa-angle-left pull-right"></i>
         ...
         <?php endif; ?>
        <?php if(auth()->guard('admin')->user()->adminType=='1'): ?>
...
<span> <?php echo e(trans('labels.Manage Admins')); ?></span> <i class="fa fa-angle-left pull-right"></i>
         ...
         <?php if(session('admin_type')==1): ?> 
         <li class="">
          <a href="<?php echo e(URL::to('admin/history')); ?>" ><i class="fa fa-tablet" aria-hidden="true"></i> <span>Admin History</span></a>
        </li>  
          <?php endif; ?>
          
           <?php if(session('admin_type')!=1): ?> 
         <li class="treeview">
          <a href="<?php echo e(URL::to('admin/AdminOrderSpecific')); ?>" ><i class="fa fa-list-ul" aria-hidden="true"></i> <span> Orders </span></a>
        </li>  
          <?php endif; ?>
          
          <?php if(session('admin_type')!=1): ?> 
         <li class="treeview">
          <a href="<?php echo e(URL::to('admin/admincustomers')); ?>" ><i class="fa fa-users" aria-hidden="true"></i> <span> Customers </span></a>
        </li>  
          <?php endif; ?>
      </ul>
    </section>
