...
<div class="registration-area">
	...
	<div class="row justify-content-center">
		<div class="col-12 col-md-6 col-lg-7 new-customers">
			...
			<p class="text-center"><?php echo app('translator')->getFromJson('website.Dont have account'); ?> 
				<a href="<?php echo e(URL::to('/signup')); ?>" class="btn btn-link ml-1"><b><?php echo app('translator')->getFromJson('website.Sign Up'); ?></b></a>
				Or 
		        <a href="<?php echo e(URL::to('/signupAsSeller')); ?>" class="btn btn-link ml-1"><b><?php echo app('translator')->getFromJson('website.Start Selling'); ?></b></a>
