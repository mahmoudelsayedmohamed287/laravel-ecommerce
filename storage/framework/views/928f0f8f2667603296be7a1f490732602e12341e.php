...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(URL::to('admin/taxrates')); ?>"><i class="fa fa-dashboard"></i><?php echo e(trans('labels.TaxRates')); ?></a></li>
              	  ...
              	  <div class="box box-info"><br>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            <?php echo Form::open(array('url' =>'admin/updatetaxrate', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>

                            <?php echo Form::hidden('id', $result['taxClass'][0]->tax_rates_id, array('class'=>'form-control', 'id'=>'tax_rate')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
                                    ...
                                    <?php $__currentLoopData = $result['tax_class']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax_class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    	<option 
                                        	<?php if($result['taxClass'][0]->tax_class_id == $tax_class->tax_class_id): ?>
                                            	selected
                                            <?php endif; ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
                                    ...
                                    <?php $__currentLoopData = $result['zones']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zones): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    	<option 
                                         <?php if($result['taxClass'][0]->tax_zone_id == $zones->zone_id): ?>
                                            	selected
                                         <?php endif; ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('tax_rate',  $result['taxClass'][0]->tax_rate, array('class'=>'form-control number-validate', 'id'=>'tax_rate')); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::textarea('tax_description',  $result['taxClass'][0]->tax_description, array('class'=>'form-control', 'id'=>'tax_description')); ?>
							...
							<div class="box-footer text-center">
								...
								<a href="<?php echo e(URL::to('admin/taxrates')); ?>" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
							</div>
                              <!-- /.box-footer -->
                            <?php echo Form::close(); ?>
