...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(URL::to('admin/taxrates')); ?>"><i class="fa fa-dashboard"></i><?php echo e(trans('labels.ListingAllTaxRates')); ?></a></li>
              	  ...
              	  <div class="box box-info"><br>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            <?php echo Form::open(array('url' =>'admin/addnewtaxrate', 'method'=>'post', 'class' => 'form-horizontal  form-validate', 'enctype'=>'multipart/form-data')); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::textarea('tax_description',  '', array('class'=>'form-control', 'id'=>'tax_description')); ?>
							...
							<div class="box-footer text-center">
								<button type="submit" class="btn btn-primary"><?php echo e(trans('labels.AddTaxRate')); ?></button>
