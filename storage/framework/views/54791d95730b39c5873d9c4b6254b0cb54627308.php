...
<div class="container">
    <div class="breadcum-area">
        <div class="breadcum-inner">
            <h3><?php echo app('translator')->getFromJson('website.singasseller'); ?></h3>
            <ol class="breadcrumb">
                
                <li class="breadcrumb-item"><a href="<?php echo e(URL::to('/')); ?>"><?php echo app('translator')->getFromJson('website.Home'); ?></a></li>
                <li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('website.Login/Register'); ?></li>
            </ol>
        </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('website.singasseller')); ?> </h3>
          </div>
            ...
            <div class="row">
              <div class="col-lg-12">
              		<div class="box box-info">
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            <?php echo Form::open(array('url' =>'signupAsSeller/addnewadmin', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                            ...
                            <hr> 
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    ...
                                    <span class="help" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.FirstNameText')); ?></span>
                                    <!-- <span class="help hidden"><?php echo e(trans('labels.textRequiredFieldMessage')); ?></span> -->
                                  </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    ...
                                    <span class="help" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.lastNameText')); ?></span>
                                    <!-- <span class="help hidden"><?php echo e(trans('labels.textRequiredFieldMessage')); ?></span> -->
                                  </div>
                                </div> 
                                <div class="form-group">
                            ...
                            <hr>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    ...
                                    <span class="help" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.StreetAddressText')); ?></span>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    ...
                                    <span class="help" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.Zip/Postal Code Text')); ?></span>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    ...
                                    <span class="help" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.CityText')); ?></span>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    ...
                                    <span class="help" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.CountryText')); ?></span>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                   <select class="form-control zoneContent" name="state">		
                                    ...
                                    <span class="help" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.StateText')); ?></span>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    ...
                                    <!-- <span class="help hidden"> <?php echo e(trans('labels.EmailError')); ?></span> -->
                                  </div>
                                </div>
                                <div class="form-group">
