                            ...
                            <?php endif; ?>
                             ...
                             <?php if($result['products']['total_record']>0): ?>
                                ...
                                <div class="products products-3x" id="listing-products">
                                    ...
                                    <?php $__currentLoopData = $result['featuresProducts']['product_data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="product">
                                        ...
                                        <span class="product-featured-tag"
                                         style="position: absolute;
                                            ...
                                            <div class="thumb"><img class="img-fluid" src="<?php echo e(asset('').$v->products_image); ?>" alt="<?php echo e($v->products_name); ?>"></div>
                                            <?php
                                            ...
                                            <div class="block-panel">
                                                <span class="tag">
                                                <?php $__currentLoopData = $v->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                	<?php echo e($category->categories_name); ?><?php if(++$key === count($v->categories)): ?> <?php else: ?>, <?php endif; ?>                                                	
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </span>
                                                <h2 class="title wrap-dot-1"><?php echo e($v->products_name); ?></h2>                                      
                                                ...
                                                <div class="block-inner">
                                                    <div class="price">
                                                        ...
                                                        <?php if(!empty($v->discount_price)): ?>
                                                            <?php echo e($web_setting[19]->value); ?><?php echo e($v->discount_price+0); ?>

                                                            <span> <?php echo e($web_setting[19]->value); ?><?php echo e($v->products_price+0); ?></span>
                                                        <?php else: ?>
                                                            <?php echo e($web_setting[19]->value); ?><?php echo e($v->products_price+0); ?>

                                                        <?php endif; ?>
                                                    </div>
                                                    
                                                    <div class="buttons">
                                                        <?php if(!in_array($v->products_id,$result['cartArray'])): ?>
                                                            <button type="button" class="btn btn-secondary btn-round cart" products_id="<?php echo e($v->products_id); ?>"><?php echo app('translator')->getFromJson('website.Add to Cart'); ?></button>
                                                        <?php elseif($v->products_min_order>1): ?>
                                                             <a class="btn btn-block btn-secondary" href="<?php echo e(URL::to('/product-detail/'.$v->products_slug)); ?>"><?php echo app('translator')->getFromJson('website.View Detail'); ?></a>
                                                        <?php else: ?>
                                            ...
                                            <div class="product-hover">
                                                <div class="icons">
                                                    <div class="icon-liked">
                                                        <span products_id = '<?php echo e($v->products_id); ?>' class="fa <?php if($v->isLiked==1): ?> fa-heart <?php else: ?> fa-heart-o <?php endif; ?> is_liked"><span class="badge badge-secondary"><?php echo e($v->products_liked); ?></span></span>
                                                        
                                                    </div>          
                                                    <?php if($v->products_type!=2): ?>
                                                        <a href="<?php echo e(URL::to('/feature-product-detail/'.$v->products_slug)); ?>" class="fa fa-eye"></a>
                                                    <?php endif; ?>
                                                </div>
                                                
                                                <div class="buttons">
                                                    <?php if($v->products_type==0): ?>
                                                        <?php if(!in_array($v->products_id,$result['cartArray'])): ?>
                                                        	<?php if($v->defaultStock==0): ?>
                                                            	<button type="button" class="btn btn-block btn-danger" products_id="<?php echo e($v->products_id); ?>"><?php echo app('translator')->getFromJson('website.Out of Stock'); ?></button>
                                                            <?php elseif($v->products_min_order>1): ?>
                                                             <a class="btn btn-block btn-secondary" href="<?php echo e(URL::to('/feature-product-detail/'.$v->products_slug)); ?>"><?php echo app('translator')->getFromJson('website.View Detail'); ?></a>
                                                            <?php else: ?>
                                                            	<button type="button" class="btn btn-block btn-secondary cart" products_id="<?php echo e($v->products_id); ?>"><?php echo app('translator')->getFromJson('website.Add to Cart'); ?></button>
                                                            <?php endif; ?>
                                                        <?php else: ?>
                                                            <button type="button" class="btn btn-block btn-secondary active"><?php echo app('translator')->getFromJson('website.Added'); ?></button>
                                                        <?php endif; ?>
                                                    <?php elseif($v->products_type==1): ?>
                                                    	<a class="btn btn-block btn-secondary" href="<?php echo e(URL::to('/feature-product-detail/'.$v->products_slug)); ?>"><?php echo app('translator')->getFromJson('website.View Detail'); ?></a>
                                                    <?php elseif($v->products_type==2): ?>
                                                    	<a href="<?php echo e($v->products_url); ?>" target="_blank" class="btn btn-block btn-secondary"><?php echo app('translator')->getFromJson('website.External Link'); ?></a>
                                                    <?php endif; ?>
                                                </div>
