                    ...
                    <?php $__currentLoopData = $results['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       ...
                       <td>
                            ...
                            <td>
                                ...
                                <a role="presentation"><a role="menuitem" tabindex="-1" href="feature?id=<?php echo e($product->products_id); ?>&stat=1">feature</a>
                               <?php }else{?>
                                 <a role="presentation"><a role="menuitem" tabindex="-1" href="feature?id=<?php echo e($product->products_id); ?>&stat=0">non feature</a>
                               <?php }?>
                              <?php endif; ?>   
