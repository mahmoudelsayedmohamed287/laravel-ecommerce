            ...
            <div class="row align-items-center">
                <div class="col-12  col-sm-12 col-lg-3 spaceright-0">
                 ...
                 <div class="col-12 col-sm-7 col-md-8 col-lg-6 px-0">      
                    ...
                    <option disabled selected value="all"><?php echo app('translator')->getFromJson('website.All Categories'); ?></option>     
                        ...
                        <div class="collapse navbar-collapse" id="navbar_collapse_1">
                          ...
                          <ul class="navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="<?php echo e(URL::to('/contact-us')); ?>"><?php echo app('translator')->getFromJson('website.Contact Us'); ?></a> </li>
                              <li class="nav-item"> <a class="nav-link" href="<?php echo e(URL::to('/admin/login')); ?>"><?php echo app('translator')->getFromJson('website.sell'); ?></a> </li>
                            <li class="nav-item last"><a href="<?php echo e(URL::to('/shop?type=special')); ?>" class="nav-link"><span style="text-align: center;width: 200px;">hotdeals</span></a></li>
                          </ul>
                        </div>
                    </nav>
...
-->
                            ...
                            <li class="nav-item"> <a class="nav-link" href="<?php echo e(URL::to('/contact-us')); ?>"><?php echo app('translator')->getFromJson('website.Contact Us'); ?></a> </li>
                              <li class="nav-item"> <a class="nav-link" href="<?php echo e(URL::to('/admin/login')); ?>"><?php echo app('translator')->getFromJson('website.sell'); ?></a> </li>
                            <li class="nav-item last"><a class="nav-link"><span><?php echo app('translator')->getFromJson('website.hotline'); ?></span></a></li>
                          </ul>
                        </div>
                    </nav>
				</div>
