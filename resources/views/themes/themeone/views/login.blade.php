...
<div class="registration-area">
	...
	<div class="row justify-content-center">
		<div class="col-12 col-md-6 col-lg-7 new-customers">
			...
			<p class="text-center">@lang('website.Dont have account') 
				<a href="{{ URL::to('/signup')}}" class="btn btn-link ml-1"><b>@lang('website.Sign Up')</b></a>
				Or 
		        <a href="{{ URL::to('/signupAsSeller')}}" class="btn btn-link ml-1"><b>@lang('website.Start Selling')</b></a>
